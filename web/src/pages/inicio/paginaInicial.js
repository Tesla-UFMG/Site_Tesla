    ...
    window.addEventListener('scroll', function(e) {
        ...
        if (!ticking) {
            window.requestAnimationFrame(function() {
                if (last_known_scroll_position < (windowHeight*3) - 50) {
                    setColor('')
                    setDisplay('')
                } else if (last_known_scroll_position >= (windowHeight*3) - 50 && last_known_scroll_position < (windowHeight*4) -50) {
                    setColor('preto')
                    setDisplay('preto')
                } else if (last_known_scroll_position >= (windowHeight*4) - 50) {
                    setColor('')
                    setDisplay('')
                }
        ...
        <div id="page1">
            ...
            <div id="page1-blog" className="container-fluid px-0">
                <div className="col-6 content">
                    ...
                    <p className="section-paragraph">Veja as noticias mais recentes no mundo da mobilidade elétrica</p>
                    <div className="buttons">
                        <Link to="/" className="section-button">conte-me mais</Link>
                    </div>
                </div>
